...
{- В Haskell, в частности в библиотеке Data.List многие функции выражены
   через внутренние функции fold и build во многом аналогичные 
   реализованным выше сверткам и разверткам. fold и build могут взаимно
   сокращать друг друга, что делает вычисления эффективными.
-}
